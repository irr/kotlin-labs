...
aws lambda create-function --region us-east-1 --function-name dynamolambda --zip-file fileb://DynamoDBTest.jar --role arn:aws:iam::041936244769:role/lambda_basic_execution --handler DynamoLambda::handler --runtime java8 --timeout 15 --memory-size 128
